...
## New release
The latest version is `2.2.22` and breaks backwards compatibility with `v1.x.x` in a big way. New features:
...
libraryDependencies += "com.github.dnvriend" %% "akka-persistence-jdbc" % "2.2.22"
```
