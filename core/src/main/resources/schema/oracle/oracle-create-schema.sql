...
CREATE SEQUENCE STATE__GLOBAL_OFFSET_SEQ START WITH 1 INCREMENT BY 1 NOMAXVALUE
/
...
CREATE OR REPLACE TRIGGER STATE__GLOBAL_OFFSET_TRG before insert on STATE REFERENCING NEW AS NEW FOR EACH ROW WHEN (new.GLOBAL_OFFSET is null) begin select STATE__GLOBAL_OFFSET_seq.nextval into :new.GLOBAL_OFFSET from sys.dual; end;
/
