...
To include the JDBC plugin into your sbt project, add the following lines to your build.sbt file:
    ...
    libraryDependencies += "com.github.dnvriend" %% "akka-persistence-jdbc" % "1.0.4"
...
```
DROP TABLE IF NOT EXISTS public.journal;
...
ALTER TABLE public.journal OWNER TO docker;

DROP TABLE IF NOT EXISTS public.snapshot;
...
ALTER TABLE public.snapshot OWNER TO docker;
```
